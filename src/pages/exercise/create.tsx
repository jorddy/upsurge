          ...
          <>
            <div className='field'>
              ...
              {errors.currentDistance && (
                <p className='text-red-600'>{errors.currentDistance.message}</p>
              )}
            </div>

            <div className='field'>
              <label htmlFor='target-distance'>Target Distance (miles):</label>
              <input
              ...
              {errors.targetDistance && (
                <p className='text-red-600'>{errors.targetDistance.message}</p>
              )}
            </div>
          </>
        )}
