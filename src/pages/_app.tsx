...
const Meta = () => {
  ...
  return (
    <Head>
      ...
      {/* Disables status bar in conjunction with standalone media query can help with IOS notch */}
      <meta
        name='apple-mobile-web-app-status-bar-style'
        content='black-translucent'
      />

      {/* Viewport tag to make app take up all avaliable space with transparent status bar */}
      <meta name='viewport' content='initial-scale=1, viewport-fit=cover' />

      {/* Manifest icons + Apple's vendor tags */}
      <link
        rel='icon'
        type='image/png'
        sizes='196x196'
